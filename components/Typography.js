...
export const InfoText = ({
  ...
  return (
    <Text
      ...
      style={{ color, fontWeight: weight, ...styles.infoText, ...customStyle }}
    >
      {text}
    </Text>
  );
...
export const BodyText = ({
  ...
  return (
    <Text
      numberOfLines={numberOfLines}
      style={{ color, fontWeight: weight, ...styles.bodyText, ...customStyle }}
    >
      {text}
    </Text>
  );
...
export const HeadingText = ({
  ...
  return (
    <Text
      numberOfLines={numberOfLines}
      style={{ color, fontWeight: weight,textAlign: align, ...styles.headingText }}
    >
      {text}
    </Text>
  );
...
export const CommentText = ({
  ...
  return (
    <Text
      numberOfLines={numberOfLines}
      style={{ color, fontWeight: weight, ...styles.CommentText, ...customStyle, }}
    >
      {text}
    </Text>
  );
...
export const OngoingEText = ({
  ...
  return (
    <Text
      numberOfLines={numberOfLines}
      style={{ color, fontWeight: weight, ...styles.OngoingEText }}
    >
      {text}
    </Text>
  );
